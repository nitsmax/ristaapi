...
class SaleApi
{
     ...
     * Get payments.
     *
     * @param string $day Date in YYYY-MM-DD (required)
     * @return \Nitsmax\Client\Model\PaymentsResult
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function paymentsGet($day)
    {
        list($response) = $this->paymentsGetWithHttpInfo($day);
        return $response;
    }
     ...
     *
     * @param string $day Date in YYYY-MM-DD (required)
     * @return Array of \Nitsmax\Client\Model\PaymentsResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function paymentsGetWithHttpInfo($day)
    {
        // verify the required parameter 'day' is set
        if ($day === null) {
            throw new \InvalidArgumentException('Missing the required parameter $day when calling paymentsGet');
        }
        // parse inputs
        ...
        // query params
        if ($day !== null) {
            $queryParams['day'] = $this->apiClient->getSerializer()->toQueryValue($day);
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Nitsmax\Client\Model\PaymentsResult',
                '/payments'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Nitsmax\Client\Model\PaymentsResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Nitsmax\Client\Model\PaymentsResult', $e->getResponseHeaders());
     ...
     * Get sale detail.
     *
     * @param string $invoice Invoice number. (required)
     * @return \Nitsmax\Client\Model\Sale
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function saleGet($invoice)
    {
        list($response) = $this->saleGetWithHttpInfo($invoice);
        return $response;
    }

    /**
     * Operation saleGetWithHttpInfo
     *
     * Get sale detail.
     *
     * @param string $invoice Invoice number. (required)
     * @return Array of \Nitsmax\Client\Model\Sale, HTTP status code, HTTP response headers (array of strings)
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function saleGetWithHttpInfo($invoice)
    {
        // verify the required parameter 'invoice' is set
        if ($invoice === null) {
            throw new \InvalidArgumentException('Missing the required parameter $invoice when calling saleGet');
        }
        // parse inputs
        $resourcePath = "/sale";
        $httpBody = '';
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Nitsmax\Client\Model\Sale',
                '/sale'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Nitsmax\Client\Model\Sale', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Nitsmax\Client\Model\Sale', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Nitsmax\Client\Model\Error', $e->getResponseHeaders());
     ...
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function salePaymentsGet($invoice)
    {
        list($response) = $this->salePaymentsGetWithHttpInfo($invoice);
        return $response;
    }

    /**
     * Operation salePaymentsGetWithHttpInfo
     *
     * Get payments for a sale.
     *
     * @param string $invoice Invoice number. (required)
     ...
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function salePaymentsGetWithHttpInfo($invoice)
    {
        // verify the required parameter 'invoice' is set
        if ($invoice === null) {
            throw new \InvalidArgumentException('Missing the required parameter $invoice when calling salePaymentsGet');
        }
        // parse inputs
        $resourcePath = "/sale/payments";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * Save sale.
     *
     * @param \Nitsmax\Client\Model\Sale $sale Sale information. (required)
     * @return \Nitsmax\Client\Model\Sale
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function salePost($sale)
    {
        list($response) = $this->salePostWithHttpInfo($sale);
        return $response;
    }

    /**
     * Operation salePostWithHttpInfo
     *
     * Save sale.
     *
     * @param \Nitsmax\Client\Model\Sale $sale Sale information. (required)
     ...
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function salePostWithHttpInfo($sale)
    {
        // verify the required parameter 'sale' is set
        if ($sale === null) {
            throw new \InvalidArgumentException('Missing the required parameter $sale when calling salePost');
        }
        // parse inputs
        $resourcePath = "/sale";
        $httpBody = '';
     ...
     * Operation salesGet
     *
     * Get sales records for a given branch on a given day.
     *
     * @param string $branch Branch Code (required)
     * @param string $day Date in YYYY-MM-DD (required)
     * @param string $status Sale status to filter. (optional)
     * @return \Nitsmax\Client\Model\SalesResult
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function salesGet($branch, $day, $status = null)
    {
        list($response) = $this->salesGetWithHttpInfo($branch, $day, $status);
        return $response;
    }
     ...
     * @param string $day Date in YYYY-MM-DD (required)
     * @param string $status Sale status to filter. (optional)
     * @return Array of \Nitsmax\Client\Model\SalesResult, HTTP status code, HTTP response headers (array of strings)
     * @throws \Nitsmax\Client\ApiException on non-2xx response
     */
    public function salesGetWithHttpInfo($branch, $day, $status = null)
    {
        // verify the required parameter 'branch' is set
        if ($branch === null) {
            throw new \InvalidArgumentException('Missing the required parameter $branch when calling salesGet');
        }
        // verify the required parameter 'day' is set
        if ($day === null) {
            throw new \InvalidArgumentException('Missing the required parameter $day when calling salesGet');
        }
        // parse inputs
        $resourcePath = "/sales";
        $httpBody = '';
        ...
        // query params
        if ($branch !== null) {
            $queryParams['branch'] = $this->apiClient->getSerializer()->toQueryValue($branch);
        }
        // query params
        if ($day !== null) {
            $queryParams['day'] = $this->apiClient->getSerializer()->toQueryValue($day);
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Nitsmax\Client\Model\SalesResult',
                '/sales'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Nitsmax\Client\Model\SalesResult', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Nitsmax\Client\Model\SalesResult', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Nitsmax\Client\Model\Error', $e->getResponseHeaders());
