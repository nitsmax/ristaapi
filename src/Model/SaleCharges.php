 ...
 * @link        https://github.com/nitsmax-api/nitsmax-codegen
 */
class SaleCharges implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $nitsmaxModelName = 'Sale_charges';
    ...
    protected static $nitsmaxTypes = array(
        ...
        'sale_amount' => 'float',
        'amount' => 'float',
        'taxes' => '\Nitsmax\Client\Model\SaleTaxes1[]'
    );
    ...
    /**
     * Sets name
     * @param string $name Name of Charge.
     * @return $this
     */
    ...
    /**
     * Sets rate
     * @param float $rate Rate of charge, absolute value or percentage.
     * @return $this
     */
    ...
    /**
     * Sets sale_amount
     * @param float $sale_amount Sale amount on which charge is applied.
     * @return $this
     */
    ...
    /**
     * Gets taxes
     * @return \Nitsmax\Client\Model\SaleTaxes1[]
     */
    ...
    /**
     * Sets taxes
     * @param \Nitsmax\Client\Model\SaleTaxes1[] $taxes Taxes for the charge.
     * @return $this
     */
