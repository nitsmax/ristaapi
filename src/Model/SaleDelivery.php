...
class SaleDelivery implements ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static $nitsmaxModelName = 'Sale_delivery';
    ...
    protected static $nitsmaxTypes = array(
        ...
        'email' => 'string',
        'phone_number' => 'string',
        'address' => '\Nitsmax\Client\Model\SaleDeliveryAddress',
        'payment_mode' => 'string',
    ...
    /**
     * Sets phone_number
     * @param string $phone_number Phone number of customer.
     * @return $this
     */
    ...
    /**
     * Gets address
     * @return \Nitsmax\Client\Model\SaleDeliveryAddress
     */
    ...
    /**
     * Sets address
     * @param \Nitsmax\Client\Model\SaleDeliveryAddress $address
     * @return $this
     */
    ...
    /**
     * Sets delivery_date
     * @param string $delivery_date Delivery date in ISO string format with timezone.
     * @return $this
     */
